...
public class UpdateTeacherCommandValidatorTests
{
    private readonly UpdateTeacherCommandValidator _validator = new();

    private static UpdateTeacherCommand CreateValidCommand() => new(
        Id: Guid.NewGuid(),
        FirstName: "John",
        LastName: "Doe",
